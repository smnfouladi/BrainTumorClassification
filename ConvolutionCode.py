...
from keras.layers import Input, Dense, Conv2D, MaxPooling2D, UpSampling1D,Cropping2D,Activation,ZeroPadding2D, Flatten, Dropout
...
def NetworkCNN():
    ...
    model.add(Conv2D(64, (2,2),padding='same', activation='relu', input_shape=( x_train.shape[1],x_train.shape[2],3)))
